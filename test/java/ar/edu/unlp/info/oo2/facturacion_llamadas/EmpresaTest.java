...
class EmpresaTest {
	...
	void testcalcularMontoTotalLlamadas() {
		Cliente emisorPersonaFisca = sistema.registrarPersonaFísica("11555666", "Brendan Eich");
		Cliente remitentePersonaFisica = sistema.registrarPersonaFísica("00000001", "Doug Lea");
		Cliente emisorPersonaJuridica = sistema.registrarPersonaJurídica("17555222", "Nvidia Corp");
		Cliente remitentePersonaJuridica = sistema.registrarPersonaJurídica("25765432", "Sun Microsystems");
	...
	void testAgregarUsuario() {
		...
		this.sistema.agregarNumeroTelefono("2214444558"); 
		Cliente nuevaPersona = this.sistema.registrarPersonaFísica("2444555","Alan Turing");
	...
	void obtenerNumeroLibre() {
		...
		this.sistema.getGestorNumeros().cambiarTipoGenerador(new GeneradorNumerosPrimero ());
		assertEquals("2214444554", this.sistema.obtenerNumeroLibre());

		this.sistema.getGestorNumeros().cambiarTipoGenerador(new GeneradorNumerosRandom ());
